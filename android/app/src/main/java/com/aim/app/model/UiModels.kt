...
data class ConversationUi(
    ...
    val accent: Color = AimColors.Primary,
    val accentSoft: Color = AimColors.PrimarySoft,
)
...
object AimSampleData {
    val conversations = listOf(
        ConversationUi(
            ...
            unreadCount = 2,
            online = true,
            accent = AimColors.Accent,
            accentSoft = AimColors.AccentSoft,
        ),
        ConversationUi(
            id = 2,
        ...
        ConversationUi(
            ...
            timeText = "周日",
            accent = AimColors.Muted,
            accentSoft = AimColors.SurfaceAlt,
        ),
    )
